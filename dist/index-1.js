...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready((function() {
	  ...
	  var allOperations = Bacon.mergeAll($('#minus-1').asEventStream('click').map(-1), $('#plus-1').asEventStream('click').map(+1), $('#plus-5').asEventStream('click').map(+5), $('#plus-10').asEventStream('click').map(+10));
